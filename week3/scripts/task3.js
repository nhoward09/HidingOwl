...
document.querySelector("#array").textContent = myList;
...
document.querySelector("#odds").textContent = myList.filter(number => number % 2 !== 0);

// Step 4: Use the filter array method to find all of the even numbers of the array variable and assign the result to the HTML element with an ID of "evens"
document.querySelector("#evens").textContent = myList.filter(number => number % 2 === 0);

// Step 5: Use the reduce array method to sum the array variable elements and assign the result to the HTML element with an ID of "sumOfArray"
document.querySelector("#sumOfArray").textContent = myList.reduce((sum, number) => sum + number, 0);
...
document.querySelector("#multiplied").textContent = myList.map(number => number * 2);

// Step 7: Use the map and reduce array methods to sum the array elements after multiplying each element by two. Assign the result to the HTML element with an ID of "sumOfMultiplied"
document.querySelector("#sumOfMultiplied").textContent = myList.map(number => number * 2).reduce((sum, number) => sum + number, 0);
